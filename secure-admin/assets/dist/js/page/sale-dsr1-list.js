...
function getAjaxResults(formId) {
    ...
    if(exp){
      ...
      const url = 'ajax/sale-dsr1-results?function=get_results&' + formData;
    ...
    $.ajax({
        type: 'POST',
        url: 'ajax/sale-dsr1-results?function=get_results',
        data: formData,
