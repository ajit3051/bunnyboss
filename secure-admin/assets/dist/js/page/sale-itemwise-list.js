...
function getAjaxResults(formId) {
    ...
    if(exp){
      ...
      const url = 'ajax/sale-itemwise-results?function=get_results&' + formData;
    ...
    $.ajax({
        type: 'POST',
        url: 'ajax/sale-itemwise-results?function=get_results',
        data: formData,
        success: function (response) {
            ...
            $('#'+formId).find('.t_qty').text(res.t_qty);
            $('#'+formId).find('.t_bal_qty').text(res.t_bal_qty);
            $('#'+formId).find('.t_rate').text(res.t_rate);
            $('#'+formId).find('.t_gst').text(res.t_gst);
            $('#'+formId).find('.t_amt').text(res.t_amt);
