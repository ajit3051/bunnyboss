...
<?php
   $msg='';
    ...
    {
     $subgroup_code = mysqli_real_escape_string($conn, $_POST['subgroup_code']);
     ...
     //   $picture=implode(' ',$data);
         ...
         $dup=mysqli_query($conn,"select * from tbl_subgroup_master where subgroup_name='$subgroup_name'");
           if(mysqli_num_rows($dup)>0)
           {
               $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>SubGroup Master Already exist!</strong>
                   </div>';
           }
           else{
               $query="Insert into tbl_subgroup_master(subgroup_code,group_name,subgroup_name,status)values('$subgroup_code','$group_name','$subgroup_name','$status')";
   ...
   document.addEventListener('DOMContentLoaded', function() {
      showPopup(
          'Success!',
          'SubGroup Name Saved Successfully 🎉',
   ...
   ";
                   ...
                   $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>SubGroup Creations Failed!</strong>
                   </div>';
               }
           } 
       }
...
<html lang="en">
   ...
   <head>
      ...
      <title>SubGroup Master Creation || TEJASERP</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>SubGroup Master Creations !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_subgroupmastercreation_list.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-list-alt" style="margin-right: 5px;"></i>SubGroup  Master List !</button></a>
                           </div>
                           <form method="post">
                              ...
                              <div class="row">
                                 <div class="col-sm-2">
                                    <div class="form-group">
                                       <label>SubGroup Code</label><label style="color:red;">*</label>
                                       <input type="password" name="subgroup_code" class="form-control" id="subgroup_code" readonly value="<?php @$no = mysqli_query($conn, "SELECT id FROM  tbl_subgroup_master ORDER BY id DESC");
                                          $po_no = ($no) ? mysqli_fetch_assoc($no) : null;
                                          $next_id = ($po_no && isset($po_no['id'])) ? ($po_no['id'] + 1) : 1;
                                          echo 'SGC-000' . $next_id;
                                          ?>">
                                    </div>
                                 </div>
                                 <div class="col-lg-5">
                                    <div class="form-group">
                                       <label>Category || Group Name</label><label style="color:red;">*</label>
                                 ...
                                 <div class="col-sm-5">
                                    <div class="form-group">
                                       <label>SubCategory || SubGroup Name</label>
                                       <input type="text" class="form-control" name="subgroup_name" id="subgroup_name" placeholder="Enter Your SubGroup Name" >
                                    </div>
                                 </div>
                              </div>
                              <br>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>SubGroup Master List !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_subgroupmastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>Add New SubGroup  Master Creation !</button></a>
                           </div>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                       ...
                                       <th data-toggle="offcanvas">SubGroup Code</th>
                                       <th data-toggle="offcanvas">Group Name</th>
                                       <th data-toggle="offcanvas">SubGroup Name</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    <?php
                                    ...
                                    <tr>
                                       ...
                                       <td class="button-btn-btn-btn2111">
                                          <a class=""onClick="return confirm('Are you sure you want to Update SubGroup Name?')" href="fh_subgroupmastercreation_update.php?update_id=<?php echo $user['id']; ?>">
                                          <span
                                             data-toggle="tooltip" title="Are you sure you want to Update SubGroup Name" type="button" class="" ><i style="color: white;" class="fa fa-pencil"></i>
                                          <br>
                                          <span style="color: white;">EDIT</span>
                                          </span></a>
                                          <br><br>
                                          <a class="" onClick="return confirm('Are you sure you want to Delete SubGroup Name List ?')" href="fh_subgroupmastercreation_list.php?delete_id=<?php echo $user['id']; ?>">
                                          <span data-toggle="tooltip" title="Are you sure you want to Delete SubGroup Name List" type="button" class="" ><i style="color:white;" class="fa fa-trash-o"></i><span style="color:white;"class="">DELETE</span></span></a>
                                          <br><br>
                                          <label class="switch1">
                                          <input type="checkbox">
                                       ...
                                       <td data-toggle="offcanvas" ><?php echo $user['subgroup_code']; ?>
                                       </td>
                                       <td data-toggle="offcanvas"><?php echo substr($user['group_name'],0,50); ?>
                                       </td>
                                       <td data-toggle="offcanvas"><?php echo substr($user['subgroup_name'],0,50); ?>
                                       </td>
                                    </tr>
                                    <?php } ?>
                                 </tbody>
