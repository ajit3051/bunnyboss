<?php include('top.php');
   ...
   {
     $id=$_GET['update_id'];
     $run=mysqli_query($conn,"select * from tbl_size_master where id='$id'");
   ...
   if(isset($_POST['update']))
      {
       ...
       $query="UPDATE tbl_size_master SET size_code='$size_code', size_name='$size_name',status='$status' WHERE id='$id'";
       if (mysqli_query($conn,$query)){
           $msg='<div class="alert alert-success alert-dismissible fade1 show">
                       <button type="button" class="close" data-dismiss="alert">&times;</button>
                       <strong>Size Name Update..!</strong>
                   </div>';
                   header('refresh:.5; url=fh_sizemastercreation_list.php');
       }
       else{
...
<html lang="en">
   ...
   <head>
      ...
      <title>Size Master Edit || TEJASERP</title>
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       ...
                                       <input type="password" name="size_code" class="form-control" readonly value="<?php echo $user['size_code'];?>" />
                                    </div>
                                 </div>
                                 <div class="col-sm-8">
                                    <div class="form-group">
                                       <label>Size Name</label><label style="color:red;">*</label>
                                       <input type="text" class="form-control" name="size_name" id="size_name"  value="<?php echo $user['size_name'];?>" placeholder="Enter Your Size Name" required>
                                    </div>
                                 </div>
                              </div>
                              <br>
