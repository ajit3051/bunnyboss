...
{
  $id=$_GET['update_id'];
  $run=mysqli_query($conn,"select * from tbl_subhead_master where id='$id'");
...
if(isset($_POST['update']))
   {
    ...
    $subhead_name = str_replace("'", "\'", $subhead_name);
    $subhead_name = str_replace('"', '\"', $subhead_name);

        
    $query="UPDATE tbl_subhead_master SET subhead_code='$subhead_code',head_name='$head_name', subhead_name='$subhead_name',status='$status' WHERE id='$id'";
        ...
        if($run)
   {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        showPopup(
            'Success!',
            'SubHead Name Update Successfully 🎉',
...
<head>
      ...
      <title>SubHead Master Update || Fashion Hub</title>
                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidisable">
                        ...
                        <div class="panel-body form-scroll">
                           ...
                           <div class="btn-group">
                              <a href="fh_subheadmastercreation_list.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>SubHead  Master List !</button></a>
                           </div>
                           <form method="post">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                            ...
                                            <input type="password" name="subhead_code" class="form-control" readonly value="<?php echo $user['subhead_code'];?>" />
                                            </div>
                                         </div>
                                         <div class="col-sm-4">
               <div class="form-group">
                  ...
                  <select name="head_name" class="form-control" required>
                                         ...
                                         <div class="col-sm-4">
                                          <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="subhead_name" id="subhead_name"  value="<?php echo $user['subhead_name'];?>" placeholder="Enter Your SubHead Name" >
                                            </div>
                                         </div>
