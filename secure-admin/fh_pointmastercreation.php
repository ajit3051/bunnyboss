...
<?php
   $msg='';
    if(isset($_POST['submit']))
    {
     ...
     $status = mysqli_real_escape_string($conn, $_POST['status']);
         ...
         $dup=mysqli_query($conn,"select * from tbl_point_master where store_name='$store_name'");
           if(mysqli_num_rows($dup)>0)
           {
               ...
               $query="Insert into tbl_point_master(point_code,point,store_name,location_name,status)values('$point_code','$point','$store_name','$location_name','$status')";
   ...
   ";
                   ...
                   $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>Point Creations Failed!</strong>
                   </div>';
               }
           } 
       }
...
<html lang="en">
   ...
   <head>
      ...
      <title>Point Master Creation || Fashion Hub</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Point Master Creations !</span>
                           </span>
                        </div>
                              ...
                              <div class="row">
                                 <div class="col-sm-2">
                                    <div class="form-group">
                                       ...
                                       <input type="password" name="point_code" class="form-control" id="point_code" readonly value="<?php @$no = mysqli_query($conn, "SELECT id FROM  tbl_point_master ORDER BY id DESC");
                                 ...
                                 <div class="col-lg-4">
                                    ...
                                    <span style="font-size:11px;" class="pull-left"><i class="fa fa-plus"></i>Add New Store Master
                                    </span>
                                    </a>
                                 </div>
                                 <div class="col-sm-4">
