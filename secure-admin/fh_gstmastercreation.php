...
<?php
   $msg='';
    ...
    {
     $gst_range  = mysqli_real_escape_string($conn, $_POST['gst_range']);
     ...
     $status     = mysqli_real_escape_string($conn, $_POST['status']);
         ...
         $dup=mysqli_query($conn,"select * from tbl_gst_master where group_name='$group_name'");
           if(mysqli_num_rows($dup)>0)
           {
               $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>GST percentage Already exist!</strong>
                   </div>';
           }
           else{
               $query="Insert into tbl_gst_master(gst_range,gst_code,gst_per,group_name,hsn_code,status)values('$gst_range','$gst_code','$gst_per','$group_name','$hsn_code','$status')";
   ...
   document.addEventListener('DOMContentLoaded', function() {
       showPopup(
           'Success!',
           'GST Percentage Creations Success 🎉',
   ...
   ";
                   ...
                   $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>GST Percentage Creations Failed!</strong>
                   </div>';
               }
           } 
       }
...
<html lang="en">
   ...
   <head>
      ...
      <title>GST Master Creation || TEJASERP</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>GST Master Creations !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_gstmastercreation_list.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-list-alt" style="margin-right: 5px;"></i>GST  Master List !</button></a>
                           </div>
                           <form method="post">
                              ...
                              <div class="row">
                                   <div class="col-lg-2">
                                    <div class="form-group">
                                       ...
                                       <input type="password" name="gst_code" class="form-control" id="gst_code" readonly value="<?php @$no = mysqli_query($conn, "SELECT id FROM  tbl_gst_master ORDER BY id DESC");
                                          $po_no = mysqli_fetch_assoc($no);echo 'GC-000'.($po_no['id']+1);
                                          ?>">
                                    </div>
                                 </div>
                                 <div class="col-lg-2">
                                    <div class="form-group">
                                       ...
                                       <select name="gst_range" class="form-control" required>
                                          <option value="null">Select GST Range </option>
                                          <option>NO</option>
                                          <option>YES</option>
                                       </select>
                                    </div>
                                 ...
                                 <div class="col-lg-3">
                                    ...
                                    <a href="#" class="" data-toggle="modal" data-target="#gst-groupmaster">
                                 ...
                                 <div class="col-lg-2">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="gst_per" id="gst_per" placeholder="Enter Your GST (%)" required>
                                    </div>
                                 </div>
                              </div>
                              <br>
...
<div class="modal fade" id="gst-groupmaster" tabindex="-1" role="dialog" aria-hidden="true">
