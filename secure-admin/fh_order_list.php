                    ...
                    <div class="container-fluid" style="padding: 0; margin-top: 15px; margin-bottom: 15px;">
                       ...
                       <div style="display: flex; align-items: center; flex-wrap: wrap; gap: 10px; padding: 0 5px;">
                          <div style="min-width: 150px;">
                               <select class="form-control" name="payment_status_filter" id="payment_status_filter" style="height: 34px;">
                                  <option value="">All Paid & Partial Paid</option>
...
<script src="<?= _BASEURL ?>assets/dist/js/page/order-list.js?v=<?= time(); ?>" type="text/javascript"></script>