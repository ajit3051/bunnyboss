...
{
  $id=$_GET['update_id'];
  $run=mysqli_query($conn,"select * from tbl_partytype_master where id='$id'");
...
if(isset($_POST['update']))
   {
    ...
    $partytype_name = str_replace("'", "\'", $partytype_name);
    $partytype_name = str_replace('"', '\"', $partytype_name);

        
    $query="UPDATE tbl_partytype_master SET partytype_code='$partytype_code', partytype_name='$partytype_name',status='$status' WHERE id='$id'";
    if (mysqli_query($conn,$query)){
        $msg='<div class="alert alert-success alert-dismissible fade1 show">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>PartType Name Update..!</strong>
                </div>';
...
<head>
      ...
      <title>PartyType Master Update || TEJASERP</title>
                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidisable">
                        ...
                        <div class="panel-body">
                            <div class="btn-group">
                              <a href="fh_partytypemastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-bars" style="margin-right: 5px;"></i>Party Type Master Creation</button></a>
                           </div>
                            <div class="btn-group">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                            ...
                                            <input type="password" name="partytype_code" class="form-control" readonly value="<?php echo $user['partytype_code'];?>" />
                                            </div>
                                         </div>
                                         <div class="col-sm-8">
                                          <div class="form-group">
                                                <label>Party Type</label>
                                                <input type="text" class="form-control" name="partytype_name" id="partytype_name"  value="<?php echo $user['partytype_name'];?>" placeholder="Enter Your PartyType Name" required>
                                            </div>
                                         </div>
