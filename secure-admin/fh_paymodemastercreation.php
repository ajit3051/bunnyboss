...
<?php
   $msg='';
    ...
    {
     $paymode_code = mysqli_real_escape_string($conn, $_POST['paymode_code']);
     $paymode_name = mysqli_real_escape_string($conn, $_POST['paymode_name']);
     $status = mysqli_real_escape_string($conn, $_POST['status']);
     
     
   
         $dup=mysqli_query($conn,"select * from tbl_paymode_master where paymode_name='$paymode_name'");
           if(mysqli_num_rows($dup)>0)
           {
               $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>Paymode Name Already exist!</strong>
                   </div>';
           }
           else{
               $query="Insert into tbl_paymode_master(paymode_code,paymode_name,status)values('$paymode_code','$paymode_name','$status')";
   ...
   document.addEventListener('DOMContentLoaded', function() {
       showPopup(
           'Success!',
           'PayMode Creation Saved Successfully 🎉',
   ...
   ";
                   ...
                   $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>Paymode Name Creations Failed!</strong>
                   </div>';
               }
           } 
       }
...
<html lang="en">
   ...
   <head>
      ...
      <title>Paymode Master Creation || TEJASERP</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Paymode Master Creations !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_paymodemastercreation_list.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-list-alt" style="margin-right: 5px;"></i>PayMode  Master List !</button></a>
                           </div>
                           <form method="post">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       <label>Paymode Code</label><label style="color:red;">*</label>
                                       <input type="password" name="paymode_code" class="form-control" id="paymode_code" readonly value="<?php @$no = mysqli_query($conn, "SELECT id FROM  tbl_paymode_master ORDER BY id DESC");
                                 ...
                                 <div class="col-sm-8">
                                    <div class="form-group">
                                       <label>Paymode Name</label><label style="color:red;">*</label>
                                       <input type="text" class="form-control" name="paymode_name" id="paymode_name" placeholder="Enter Your Paymode Name" required>
                                    </div>
                                 </div>
                              </div>
                              <br>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Paymode Master List !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_paymodemastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>PayMode Master Creation !</button></a>
                           </div>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                       ...
                                       <th data-toggle="offcanvas">Paymode Code</th>
                                       <th data-toggle="offcanvas">Paymode Name</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    <?php
                                    ...
                                    <tr>
                                       ...
                                       <td class="button-btn-btn-btn2111">
                                          <a class=""onClick="return confirm('Are you sure you want to Update Paymode Name?')" href="fh_paymodemastercreation_update.php?update_id=<?php echo $user['id']; ?>">
                                          <span
                                             data-toggle="tooltip" title="Are you sure you want to Update Paymode Name" type="button" class="" ><i style="color: white;" class="fa fa-pencil"></i>
                                             <br>
                                             <span style="color: white;">EDIT</span>
                                          </span></a>
                                          <br><br>
                                          <a class="" onClick="return confirm('Are you sure you want to Delete Paymode Name List ?')" href="fh_paymodemastercreation_list.php?delete_id=<?php echo $user['id']; ?>">
                                          <span data-toggle="tooltip" title="Are you sure you want to Delete Paymode Name List" type="button" class="" ><i style="color:white;" class="fa fa-trash-o"></i><span style="color:white;"class="">DELETE</span></span></a>
                                          <br><br>
                                          <label class="switch1">
                                          <input type="checkbox">
                                       ...
                                       <td data-toggle="offcanvas"><?php echo $user['paymode_code']; ?>
                                       </td>
                                       <td data-toggle="offcanvas"><?php echo substr($user['paymode_name'],0,50); ?>
                                       </td>
                                    </tr>
                                    <?php } ?>
                                 </tbody>
