...
<?php
    $msg='';
     ...
     {
      $exphead_code = mysqli_real_escape_string($conn, $_POST['exphead_code']);
      ...
      // $picture=implode(' ',$data);
          ...
          $dup=mysqli_query($conn,"select * from tbl_expenseshead_master where exphead_name='$exphead_name'");
            if(mysqli_num_rows($dup)>0)
            {
                $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Expenses Head Name Already exist!</strong>
                    </div>';
            }
            else{
                $query="Insert into tbl_expenseshead_master(exphead_code,exphead_name,status)values('$exphead_code','$exphead_name','$status')";
                if(mysqli_query($conn,$query)){
                    $msg='<div class="alert alert-success alert-dismissible fade1 show">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Expenses Head Name Creations Success..!</strong>
                  </div>';
                }
                else{
                    $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Expenses Head Name Creations Failed!</strong>
                    </div>';
                }
            } 
        }
...
<head>
      ...
      <title>Expenses Head Master Creation || TEJASERP</title>
                        ...
                        <div class="panel-body">
                           ...
                           <form method="post">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                                        <label>ExpensesHead Code</label><label style="color:red;">*</label>
                                                        <input type="password" name="exphead_code" class="form-control" id="exphead_code" readonly value="<?php @$no = mysqli_query($conn, "SELECT id FROM  tbl_expenseshead_master ORDER BY id DESC");
                                                        $po_no = ($no) ? mysqli_fetch_assoc($no) : null;
                                                        $next_id = ($po_no && isset($po_no['id'])) ? ($po_no['id'] + 1) : 1;
                                                        echo 'EHC-000' . $next_id;
                                                    ?>">
                                                </div>
                                             </div>
                                             <div class="col-sm-8">
                                                <div class="form-group">
                                                   <label>ExpensesHead Name</label><label style="color:red;">*</label>
                                                   <input type="text" class="form-control" name="exphead_name" id="exphead_name" placeholder="Enter Your Expenses Head Name" required>
                                                </div>
                                             </div>
           ...
           <section class="">
               <div class="row">
                  ...
                  <div class="panel-heading">
                        ...
                        <div class="panel-body">
                            <div class="btn-group">
                              <a href="fh_expenses_headmastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>Expenses Head Master Creation</button></a>
                           </div>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    <?php
                                          ...
                                          <a class=""onClick="return confirm('Are you sure you want to Update Expenses Head Master')" href="fh_expensesheadmastercreation_update.php?update_id=<?php echo $user['id']; ?>">
                                          <span
                                             data-toggle="tooltip" title="Are you sure you want to Update Expenses Head Master" type="button" class="" ><i style="color: white;" class="fa fa-pencil"></i><br><span style="margin-left:0px; color: white;">EDIT</span>
                                          </span></a><br><br>
                                          <a class="" onClick="return confirm('Are you sure you want to Delete Expenses Head Master List ?')" href="fh_expensesheadmastercreation_list.php?delete_id=<?php echo $user['id']; ?>">
                                          <span data-toggle="tooltip" title="Are you sure you want to Delete Expenses Head Master List" type="button" class="" ><i style="margin-left: 0px; color:white;" class="fa fa-trash-o"></i><span style="margin-left:0px; color:white;"class="">DELETE</span></span></a>
                                          <br><br>
                                          ...
                                          <span data-toggle="tooltip" title="Are you sure you want to Delete Expenses Head Name List" type="button" class="" ><i style="margin-left: 0px; color:white;" class="fa fa fa-list-alt"></i><span style="margin-left:0px; color:white;">DETAILS</span></span></a>
                                          <br><br>
                                          <label class="switch1">
                                          <input type="checkbox">
