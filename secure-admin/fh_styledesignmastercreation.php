...
<?php
   $msg='';
    if(isset($_POST['submit']))
    {
     ...
     $status     = mysqli_real_escape_string($conn, $_POST['status']);
         ...
         $dup=mysqli_query($conn,"select * from tbl_styledesign_master where style_name='$style_name'");
           if(mysqli_num_rows($dup)>0)
           {
               $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>Style || Design Name Already exist!</strong>
                   </div>';
           }
           else{
               $query="Insert into tbl_styledesign_master(style_code,style_name,status)values('$style_code','$style_name','$status')";
   ...
   document.addEventListener('DOMContentLoaded', function() {
       showPopup(
           'Success!',
           'Style || Design Name Saved Successfully 🎉',
   ...
   ";
                   ...
                   $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>Style || Design Name Creations Failed!</strong>
                   </div>';
               }
           } 
       }
...
<html lang="en">
   ...
   <head>
      ...
      <title>Style || Design Master Creation || TEJASERP</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>style || Design Master Creations !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           ...
                           <form method="post">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       <label>Style Code</label><label style="color:red;">*</label>
                                       <input type="password" name="style_code" class="form-control" id="style_code" readonly value="<?php @$no = mysqli_query($conn, "SELECT id FROM  tbl_styledesign_master ORDER BY id DESC");
                                 ...
                                 <div class="col-sm-8">
                                    <div class="form-group">
                                       <label>Style Name</label><label style="color:red;">*</label>
                                       <input type="text" class="form-control" name="style_name" id="style_name" placeholder="Enter Your Style Name" required>
                                    </div>
                                 </div>
                              </div>
                              <br>
