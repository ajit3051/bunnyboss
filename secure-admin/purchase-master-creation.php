...
<?php
   ...
   die; */
      ...
      $sp                     = $_POST['sp'] ?? $selling_price;
      $total_amount2          = $_POST['total_amount2'] ?? '0';
      ...
      if ($_POST['form_action'] == 'save') {
         ...
         foreach ($barcode_no as $k => $barcode) {
            ...
            $insertid = $db->insert('INSERT INTO tbl_purchase (
               ...
               mrp, discount_percent2, discount_amount2, selling_price, sp, total_amount2,
               ...
               $mrp[$k], $discount_percent2[$k], $discount_amount2[$k], $selling_price[$k], $sp[$k], $total_amount2,
         ...
         foreach ($barcode_no as $k => $barcode) {
            ...
            if ($isExist) {
               ...
               $insertid = $db->update(
                  ...
                  $bbr_qty[$k], $qty[$k], $mou_name[$k], $rate[$k] ?? '',
                  $purchase_price[$k], $percent_discount[$k], $discount_amt[$k], $after_pp[$k],
                  $mrp[$k], $discount_percent2[$k], $discount_amount2[$k], $selling_price[$k], $sp[$k],
                  $net_price[$k], $gst[$k], $cgst, $sgst, $gst_amount[$k], $taxable_amount[$k], $amount[$k],
                  $current_date,
                  $item_id[$k]
                  );
...
<!-- Inline styles moved to assets/dist/css/stylecrm.css -->
<!--end plus icon-->
...
<!-- Inline styles for delete button and popup suggestions moved to assets/dist/css/stylecrm.css -->
<!-- Main content -->
<section class="">
      ...
      <div class="col-sm-12">
         <div class="panel lobidisable panel-bd">
             <!-- GROUP DETAILS POPUP -->
               ...
               <!--group name POPUP end -->
               <!-- pp Discount POPUP start -->
               ...
               <!-- pp Discount POPUP end -->
               <!-- mrp Discount popup start --> 
               ...
               <!-- mrp Discount popup end --> 
            <div class="panel-heading"data-toggle="offcanvas">
               <div class="btn-group" id="buttonexport">
                  <a href="#">
                     <h5><span style="margin-left:10px;">Purchase Master Creations</span></h5>
                  </a>
               </div>
               
              
            </div>
            <!-- Inline sidebar toggle / left panel styles moved to assets/dist/css/stylecrm.css -->
            <div class="panel-body form-scroll">
               ...
               <form method="post" name="purchage_form" id="purchage_form" enctype="multipart/form-data">
                  ...
                  <div class="leftside-panel" id="leftPanel">
                     ...
                     <!-- Inline modern-form-group styles moved to assets/dist/css/stylecrm.css -->
                     <!-- YOUR FILTER CONTENT -->
                     <div class="panel-content">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4 col-12">
                              <div class="modern-form-group">
                                 ...
                                 <select name="under_gst" id="under_gst" class="modern-select" required>
                                    <option>Local</option>
                                    <option>Inter</option>
                                 </select>
                              </div>
                           ...
                           <div class="col-md-4 col-12">
                              <div class="modern-form-group">
                                 ...
                                 <select name="bill_type" id="bill_type" class="modern-select" required>
                        ...
                        <div class="row">
                           ...
                           <input type="hidden" name="total_amount2" id="total_amount2_input" value="<?= htmlspecialchars($total_amount2 ?? '0'); ?>">
                           <div class="col-md-4">
                              <div class="modern-form-group">
                                 <label>
                                 Adjustment amount
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <div class="form-group" style="margin-top:-13px; margin-bottom:-9px;">
                           <!--<label>Item Search / Name</label>-->
                           <input type="text" class="form-control-control" name="item_name" id="item_name" placeholder="Enter Item Name" autocomplete="off" value="<?= $item_name ?>">
                  ...
                  <div class="row">
                     <div class="col-sm-3" style="">
                        ...
                        <div class="">
                           <button type="reset" class="btn btn-warning btnreset" style="width:100px;height:50px;">Clear</button>
                           <button type="reset" class="btn btn-danger btnreset" style="width:150px; height:50px; padding-top:5px;" onclick="deleteRow('dataTable')">Row Remove</button>
                        </div>
                     </div>
                     <br>
                     <div class="col-sm-3">
                     ...
                     <div class="col-sm-3">
                        <div class="form-check">
                           <label>Receipt Print Option</label><br>
                           <label class="radio-inline">
                           <input type="radio" name="status" value="success" checked="checked">80 MM</label>
                           <label class="radio-inline"><input type="radio" name="status" value="hold">A4</label>
                           <label class="radio-inline"><input type="radio" name="status" value="hold">A5</label>
                        </div>
                     </div>
                     ...
                     <div class="col-sm-3">
                           ...
                           <button type="button" class="btn btn-success probtn" onclick="openPopupsave()" id="confirmbtn" style="width:250px; height:50px; background-color: #37475a; color: white;"><?= (!empty($bill_no) ? 'Update' :'Bill Proceed') ?></button>
                  ...
                  <div class="modern-popup-save" id="modernPopup-save">
                     <div class="popup-box">
                        ...
                        <h3 class="popup-title" style="text-align:center; margin-top:-10px;">Payment mode details</h3>
                        ...
                        <div class="form-group-modern" style="text-align: center; margin-top:-10px;">
                        ...
                        <!-- BUTTONS -->
                        <div class="popup-actions"style="margin-top:0px;">
...
<section class="">
   <div class="row"style="margin-left:-28px; margin-right:-28px;" >
      <div class="col-sm-12">
         <div class="panel panel-bd lobidisable" style="margin-right:5px;">
            <div class="panel-heading"data-toggle="offcanvas">
               <div class="btn-group" id="buttonexport">
                  <a href="#">
            ...
            <div class="panel-body form-scroll">
               <form name="searchForm" id="searchForm" method="post" class="search-form"style="margin-top:-25px;" action="" autocomplete="off">
               ...
               <div class="btn-group" style="margin-top:-3px;">
                  ...
                  <a href="purchase-master-itemwise-list.php"><button class="btn btn-exp btn-sm dropdown-toggle ppbilllist" data-toggle=""style="background-color:#37475a;"><i class="fa fa-bars"></i><span style="margin-left:3px;">Purchase ItemWise List !</span></button></a>
                  <a href="purchase-master-billwise-list.php"><button class="btn btn-exp btn-sm dropdown-toggle ppbilllist" data-toggle=""style="background-color:#37475a; border-top-right-radius: 0px; border-bottom-right-radius: 0px; margin-left:-4px;"><i class="fa fa-bars"></i><span style="margin-left:3px;">Purchase BillWise List !</span></button></a>
                  <div class="btn-group">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-4" style="text-align:right;">
                     <button class="btn btn-danger btn-sm ppbilllist dwc" onclick="deleteRow('latestRecord')"><i class="fa fa-trash"></i><span style="margin-left:3px;">Delete with Checkbox</span></button>
                  </div>
               </div>
               <br>
            </div>
...
<script>
   ...
   function updateAdditionalChargesTotal() {
      var other = parseFloat(document.getElementById('other_amount')?.value) || 0;
      var labour = parseFloat(document.getElementById('labour_amount')?.value) || 0;
      var totalNet = parseFloat(document.getElementById('total_net_amount2')?.textContent) || 0;
      var totalGst = parseFloat(document.getElementById('total_gst_amount2')?.textContent) || 0;
      var total = totalNet + totalGst + other + labour;
      var totalEl = document.getElementById('total_amount2');
      if (totalEl) totalEl.textContent = total.toFixed(2);
      var input = document.getElementById('total_amount2_input');
      if (input) input.value = total.toFixed(2);
   }
   var otherInput = document.getElementById('other_amount');
   var labourInput = document.getElementById('labour_amount');
   if (otherInput) otherInput.addEventListener('input', updateAdditionalChargesTotal);
   if (labourInput) labourInput.addEventListener('input', updateAdditionalChargesTotal);
   window.addEventListener('load', updateAdditionalChargesTotal);
</script>
<!--end sidebar-toggle-->