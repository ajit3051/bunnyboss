<?php include('top.php');
   ...
   {
     $id=$_GET['update_id'];
     $run=mysqli_query($conn,"select * from tbl_festival_master where id='$id'");
   ...
   if(isset($_POST['update']))
      {
       $msg="";
         $fest_code = mysqli_real_escape_string($conn, $_POST['fest_code']);
         $fest_name = mysqli_real_escape_string($conn, $_POST['fest_name']);
         $status = mysqli_real_escape_string($conn, $_POST['status']);
   
       $fest_name = str_replace("'", "\'", $fest_name);
       $fest_name = str_replace('"', '\"', $fest_name);
   
           
       $query="UPDATE tbl_festival_master SET fest_code='$fest_code', fest_name='$fest_name',status='$status' WHERE id='$id'";
       if (mysqli_query($conn,$query)){
           $msg='<div class="alert alert-success alert-dismissible fade1 show">
                       <button type="button" class="close" data-dismiss="alert">&times;</button>
                       <strong>Festival Name Update..!</strong>
                   </div>';
                   header('refresh:.5; url=fh_festivalmastercreation_list.php');
       }
       else{
...
<html lang="en">
   ...
   <head>
      ...
      <title> Master Update || TEJASERP</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Festival Master Edit !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_festivalmastercreation_list.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>Festival Master List</button></a>
                           </div>
                           <form method="post">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       <label>Festival Code</label><label style="color:red;">*</label>
                                       <input type="password" name="fest_code" class="form-control" readonly value="<?php echo $user['fest_code'];?>" />
                                    </div>
                                 </div>
                                 <div class="col-sm-8">
                                    <div class="form-group">
                                       <label>Festival Name</label><label style="color:red;">*</label>
                                       <input type="text" class="form-control" name="fest_name" id="fest_name"  value="<?php echo $user['fest_name'];?>" placeholder="Enter Your Festival Name" required>
                                    </div>
                                 </div>
                              </div>
                              <br>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Festival Master List !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_festivalmastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>Add New Festival Master Creation</button></a>
                           </div>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                       ...
                                       <th data-toggle="offcanvas">Festival Code</th>
                                       <th data-toggle="offcanvas">Festival Name</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    <?php
                                    ...
                                    <tr>
                                       ...
                                       <td class="button-btn-btn-btn2111">
                                          <a class=""onClick="return confirm('Are you sure you want to Update Color Name?')" href="fh_festivalmastercreation_update.php?update_id=<?php echo $user['id']; ?>">
                                          <span
                                             data-toggle="tooltip" title="Are you sure you want to Update Festival Name" type="button"><i style="color: white;" class="fa fa-pencil"></i><br>
                                          <span style="color: white;">EDIT</span>
                                          </span></a>
                                          <br><br>
                                          <a class="" onClick="return confirm('Are you sure you want to Delete Festival Name List ?')" href="fh_festivalmastercreation_list.php?delete_id=<?php echo $user['id']; ?>">
                                          <span data-toggle="tooltip" title="Are you sure you want to Delete Color Name List" type="button"><i style="color:white;" class="fa fa-trash-o"></i><span style="color:white;"class="">DELETE</span></span></a>
                                          <br><br>
                                          <label class="switch1">
                                          <input type="checkbox">
                                       ...
                                       <td data-toggle="offcanvas"><?php echo $user['fest_code']; ?>
                                       </td>
                                       <td data-toggle="offcanvas"><?php echo substr($user['fest_name'],0,50); ?>
                                       </td>
                                    </tr>
                                    <?php } ?>
                                 </tbody>
