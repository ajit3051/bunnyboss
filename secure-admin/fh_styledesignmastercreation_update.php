...
{
  $id=$_GET['update_id'];
  $run=mysqli_query($conn,"select * from tbl_styledesign_master where id='$id'");
...
if(isset($_POST['update']))
   {
    $msg="";
      $style_code = mysqli_real_escape_string($conn, $_POST['style_code']);
    ...
    $query="UPDATE tbl_styledesign_master SET style_code='$style_code', style_name='$style_name',status='$status' WHERE id='$id'";
    if (mysqli_query($conn,$query)){
        $msg='<div class="alert alert-success alert-dismissible fade1 show">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Style || Design Name Update..!</strong>
                </div>';
                header('refresh:.5; url=fh_styledesignmastercreation_list.php');
    }
    else{
...
<head>
      ...
      <title>Style||Design Master Edit || TEJASERP</title>
                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidisable">
                        ...
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_styledesignmastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>Add New Style || Design Master Creation !</button></a>
                           </div>
                           <div class="btn-group">
                              <a href="fh_styledesignmastercreation_list.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-list-alt" style="margin-right: 5px;"></i>Style || Design Master List !</button></a>
                           </div>
                           <form method="post">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                            <label>Style||Design Code</label><label style="color:red;">*</label>
                                            <input type="password" name="style_code" class="form-control" readonly value="<?php echo $user['style_code'];?>" />
                                            </div>
                                         </div>
                                         <div class="col-sm-8">
                                          <div class="form-group">
                                                <label>Style||Design Name</label><label style="color:red;">*</label>
                                                <input type="text" class="form-control" name="style_name" id="style_name"  value="<?php echo $user['style_name'];?>" placeholder="Enter Your Style Name" required>
                                            </div>
                                         </div>
                                 ...
                                 <br>
                                      ...
                                      <div class="container-fluid">
                                       <div class="row">
                                          <a href="fh_styledesignmastercreation.php"><button type="Reset" name="Reset" class="btn btn-warning" style="width:100px;">Reset</button></a>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Style || Design Master List !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                       ...
                                       <th data-toggle="offcanvas">Style Code</th>
                                       <th data-toggle="offcanvas">Style Name</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    <?php
                                    ...
                                    <tr>
                                       ...
                                       <td class="button-btn-btn-btn2111">
                                          <a class=""onClick="return confirm('Are you sure you want to Update Style Name?')" href="fh_styledesignmastercreation_update.php?update_id=<?php echo $user['id']; ?>">
                                          <span
                                             data-toggle="tooltip" title="Are you sure you want to Update Style Name" type="button" class="" ><i style="color: white;" class="fa fa-pencil"></i>
                                             <br>
                                             <span style="color: white;">EDIT</span>
                                          </span></a>
                                          <br><br>
                                          <a class="" onClick="return confirm('Are you sure you want to Delete Style Name List ?')" href="fh_styledesignmastercreation_list.php?delete_id=<?php echo $user['id']; ?>">
                                          <span data-toggle="tooltip" title="Are you sure you want to Delete Style Name List" type="button" class="" ><i style="color:white;" class="fa fa-trash-o"></i><span style="color:white;"class="">DELETE</span></span></a>
                                          <br><br>
                                       ...
                                       <td data-toggle="offcanvas"><?php echo $user['style_code']; ?>
                                       </td>
                                       <td data-toggle="offcanvas"><?php echo substr($user['style_name'],0,50); ?>
                                       </td>
                                    </tr>
                                    <?php } ?>
                                 </tbody>
