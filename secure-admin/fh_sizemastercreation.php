...
<?php
   $msg='';
    if(isset($_POST['submit']))
    {
     ...
     $status    = mysqli_real_escape_string($conn, $_POST['status']);
         ...
         $dup=mysqli_query($conn,"select * from tbl_size_master where size_name='$size_name'");
           if(mysqli_num_rows($dup)>0)
           {
               $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>Size Name Already exist!</strong>
                   </div>';
           }
           else{
               $query="Insert into tbl_size_master(size_code,size_name,status)values('$size_code','$size_name','$status')";
   ...
   ";
                   ...
                   $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>Size Name Creations Failed!</strong>
                   </div>';
               }
           } 
       }
...
<html lang="en">
   ...
   <head>
      ...
      <title>Size Master Creation || TEJASERP</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Size Master Creations !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_sizemastercreation_list.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-list-alt" style="margin-right: 5px;"></i>Size  Master List !</button></a>
                           </div>
                           <form method="post">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       <label>Size Code</label><label style="color:red;">*</label>
                                       <input type="password" name="size_code" class="form-control" id="size_code" readonly value="<?php @$no = mysqli_query($conn, "SELECT id FROM  tbl_size_master ORDER BY id DESC");
                                 ...
                                 <div class="col-sm-8">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="size_name" id="size_name" placeholder="Enter Your Size Name" required>
                                    </div>
                                 </div>
                              </div>
                              <br>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Size Master List !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_sizemastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>Add New Size Master Creation !</button></a>
                           </div>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                       ...
                                       <th data-toggle="offcanvas">Size Code</th>
                                       <th data-toggle="offcanvas">Size Name</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    <?php
                                    ...
                                    <tr>
                                       ...
                                       <td class="button-btn-btn-btn2111">
                                          <a class=""onClick="return confirm('Are you sure you want to Update Size Name?')" href="fh_sizemastercreation_update.php?update_id=<?php echo $user['id']; ?>">
                                          <span
                                             data-toggle="tooltip" title="Are you sure you want to Update Size Name" type="button" class="" ><i style="color: white;" class="fa fa-pencil"></i>
                                          <br>
                                          <span style="color: white;">EDIT</span>
                                          </span></a>
                                          <br><br>
                                          <a class="" onClick="return confirm('Are you sure you want to Delete Size Name List ?')" href="fh_sizemastercreation_list.php?delete_id=<?php echo $user['id']; ?>">
                                          <span data-toggle="tooltip" title="Are you sure you want to Delete Size Name List" type="button" class="" ><i style="color:white;" class="fa fa-trash-o"></i><span style="color:white;"class="">DELETE</span></span></a>
                                          <br><br>
                                          <label class="switch1">
                                          <input type="checkbox">
                                       ...
                                       <td data-toggle="offcanvas"><?php echo $user['size_code']; ?>
                                       </td>
                                       <td data-toggle="offcanvas"><?php echo substr($user['size_name'],0,50); ?>
                                       </td>
                                    </tr>
                                    <?php } ?>
                                 </tbody>
