<?php include('top.php');
   ...
   {
     $id=$_GET['update_id'];
     $run=mysqli_query($conn,"select * from tbl_paymode_master where id='$id'");
   ...
   if(isset($_POST['update']))
      {
       ...
       $paymode_name = str_replace("'", "\'", $paymode_name);
       $paymode_name = str_replace('"', '\"', $paymode_name);
   
           
       $query="UPDATE tbl_paymode_master SET paymode_code='$paymode_code', paymode_name='$paymode_name',status='$status' WHERE id='$id'";
       if (mysqli_query($conn,$query)){
           $msg='<div class="alert alert-success alert-dismissible fade1 show">
                       <button type="button" class="close" data-dismiss="alert">&times;</button>
                       <strong>Paymode Name Update..!</strong>
                   </div>';
                   header('refresh:.5; url=fh_paymodemastercreation_list.php');
       }
       else{
...
<html lang="en">
   ...
   <head>
      ...
      <title>Paymode Master Update || TEJASERP</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Paymode Master Edit !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_paymodemastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>Add New PayMode Master Creation !</button></a>
                           </div>
                           <div class="btn-group">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       ...
                                       <input type="password" name="paymode_code" class="form-control" readonly value="<?php echo $user['paymode_code'];?>" />
                                    </div>
                                 </div>
                                 <div class="col-sm-8">
                                    <div class="form-group">
                                       <label>PayMode Name</label><label style="color:red;">*</label>
                                       <input type="text" class="form-control" name="paymode_name" id="paymode_name"  value="<?php echo $user['paymode_name'];?>" placeholder="Enter Your Paymode Name" required>
                                    </div>
                                 </div>
                              </div><br>
                              <div class="row">
