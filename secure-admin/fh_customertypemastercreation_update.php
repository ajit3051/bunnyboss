...
{
  $id=$_GET['update_id'];
  $run=mysqli_query($conn,"select * from tbl_customertype_master where id='$id'");
...
if(isset($_POST['update']))
   {
    $msg="";
      $customertype_code = mysqli_real_escape_string($conn, $_POST['customertype_code']);
    ...
    $query="UPDATE tbl_customertype_master SET customertype_code='$customertype_code',customer_type='$customer_type',discount_per='$discount_per',status='$status' WHERE id='$id'";
    if (mysqli_query($conn,$query)){
        $msg='<div class="alert alert-success alert-dismissible fade1 show">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Customer Type Master Update..!</strong>
                </div>';
                header('refresh:.5; url=fh_customertypemastercreation_list.php');
    }
    else{
...
<head>
      ...
      <title>Customer Type Master Update || TEJASERP</title>
                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidisable">
                        ...
                        <div class="panel-body">
                            <div class="btn-group">
                              <a href="fh_customertypemastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-bars" style="margin-right: 5px;"></i>Customer Type Master Creation</button></a>
                           </div>
                           <div class="btn-group">
                              <a href="fh_customertypemastercreation_list.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-bars" style="margin-right: 5px;"></i>Customer Type Master List</button></a>
                           </div>
                           <form method="post">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                            <label>CustomerType Code</label><label style="color:red;">*</label>
                                            <input type="password" name="customertype_code" class="form-control" readonly value="<?php echo $user['customertype_code'];?>" />
                                            </div>
                                         </div>
                                         <div class="col-sm-4">
                                          <div class="form-group">
                                                <label>Customer Type</label><label style="color:red;">*</label>
                                                <input type="text" class="form-control" name="customer_type" id="customer_type"  value="<?php echo $user['customer_type'];?>" placeholder="Enter Your Customer Type" required>
                                            </div>
                                         </div>
                                         ...
                                         <div class="col-sm-4">
                                          <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="discount_per" id="discount_per"  value="<?php echo $user['discount_per'];?>" placeholder="Enter Your Discount %" required>
                                            </div>
                                         </div>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <span style="font-size: 15px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><defs><clipPath id="lineMdWatchTwotoneLoop0"><rect width="24" height="12"/></clipPath><symbol id="lineMdWatchTwotoneLoop1"><path fill="#808080" fill-opacity="0" stroke="#808080" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M23 16.5C23 10.4249 18.0751 5.5 12 5.5C5.92487 5.5 1 10.4249 1 16.5z" clip-path="url(#lineMdWatchTwotoneLoop0)"><animate attributeName="d" dur="6s" keyTimes="0;0.07;0.93;1" repeatCount="indefinite" values="M23 16.5C23 11.5 18.0751 12 12 12C5.92487 12 1 11.5 1 16.5z;M23 16.5C23 10.4249 18.0751 5.5 12 5.5C5.92487 5.5 1 10.4249 1 16.5z;M23 16.5C23 10.4249 18.0751 5.5 12 5.5C5.92487 5.5 1 10.4249 1 16.5z;M23 16.5C23 11.5 18.0751 12 12 12C5.92487 12 1 11.5 1 16.5z"/><animate fill="freeze" attributeName="fill-opacity" begin="0.6s" dur="0.15s" values="0;0.3"/></path></symbol><mask id="lineMdWatchTwotoneLoop2"><use href="#lineMdWatchTwotoneLoop1"/><use href="#lineMdWatchTwotoneLoop1" transform="rotate(180 12 12)"/><circle cx="12" cy="12" r="0" fill="#fff"><animate attributeName="r" dur="6s" keyTimes="0;0.03;0.97;1" repeatCount="indefinite" values="0;3;3;0"/></circle></mask></defs><rect width="24" height="24" fill="currentColor" mask="url(#lineMdWatchTwotoneLoop2)"/></svg><span>CustomerType Master List !</span></span>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    <?php
                                          ...
                                          <a class=""onClick="return confirm('Are you sure you want to Update Customer Type Master')" href="fh_customertypemastercreation_update.php?update_id=<?php echo $user['id']; ?>">
                                          <span
                                             data-toggle="tooltip" title="Are you sure you want to Update Customer Type Master" type="button" class="" ><i style="color: white;" class="fa fa-pencil"></i><br><span style="margin-left:0px; color: white;">EDIT</span>
                                          </span></a><br><br>
                                          <a class="" onClick="return confirm('Are you sure you want to Delete Customer Type Master List ?')" href="fh_customertypemastercreation_list.php?delete_id=<?php echo $user['id']; ?>">
                                          <span data-toggle="tooltip" title="Are you sure you want to Delete Customer Type Master List" type="button" class="" ><i style="margin-left: 0px; color:white;" class="fa fa-trash-o"></i><span style="margin-left:0px; color:white;"class="">DELETE</span></span></a>
                                          <br><br>
                                          ...
                                          <span data-toggle="tooltip" title="Are you sure you want to Delete Customer Type Name List" type="button" class="" ><i style="margin-left: 0px; color:white;" class="fa fa fa-list-alt"></i><span style="margin-left:0px; color:white;">DETAILS</span></span></a>
                                          <br><br>
                                          <label class="switch1">
                                          <input type="checkbox">
                                       ...
                                       <td>
                                          ...
                                          <td><?php echo $user['customertype_code']; ?>
                                             
                                          </td>
                                          <td><?php echo substr($user['customer_type'],0,50); ?>
