<?php include('top.php');
   ...
   {
     $id=$_GET['update_id'];
     $run=mysqli_query($conn,"select * from tbl_point_master where id='$id'");
   ...
   if(isset($_POST['update']))
      {
       $msg="";
         $point_code = mysqli_real_escape_string($conn, $_POST['point_code']);
       ...
       $query="UPDATE tbl_point_master SET point_code='$point_code', point='$point',store_name='$store_name', location_name='$location_name',status='$status' WHERE id='$id'";
       if (mysqli_query($conn,$query)){
           $msg='<div class="alert alert-success alert-dismissible fade1 show">
                       <button type="button" class="close" data-dismiss="alert">&times;</button>
                       <strong>Point Master Update..!</strong>
                   </div>';
...
<html lang="en">
   ...
   <head>
      ...
      <title>Point Master Edit || TEJASERP</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Point Master Edit !</span>
                           </span>
                        </div>
                        <div class="panel-body">
                           <div class="btn-group">
                              <a href="fh_pointmastercreation_list.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-bars" style="margin-right: 5px;"></i>Point Master List</button></a>
                           </div>
                           <form method="post">
                              ...
                              <div class="row">
                                 <div class="col-sm-2">
                                    <div class="form-group">
                                       <label>Point Code</label><label style="color:red;">*</label>
                                       <input type="password" name="point_code" class="form-control" readonly value="<?php echo $user['point_code'];?>" />
                                    </div>
                                 </div>
                                 <div class="col-sm-2">
                                    <div class="form-group">
                                       <label>Point %</label><label style="color:red;">*</label>
                                       <input type="text" class="form-control" name="point" id="point"  value="<?php echo $user['point'];?>" placeholder="Enter Your Point" required>
                                    </div>
                                 </div>
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       ...
                                       <select name="store_name" class="form-control" required>
                                          ...
                                          <?php
                                             $query = mysqli_query($conn, "SELECT * FROM tbl_store_master");while ($row = mysqli_fetch_array($query)) {
