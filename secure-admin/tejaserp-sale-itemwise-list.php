...
<?php
   ...
   if ($_POST['action'] == 'delete' && $_POST['id'] != '') {
      ...
      redirectTo('tejaserp-sale-itemwise-list.php', $msg, $code);
      ...
      if ($mail_to) {
         ...
         redirectTo('tejaserp-sale-itemwise-list.php' . $sendid, 'Mail has been sent successfully');
      } else {
         redirectTo('tejaserp-sale-itemwise-list.php' . $sendid, 'Email id not found.', 1);
      }
   }
   ?>
         ...
         <div class="panel panel-bd lobidisable">
            <div class="panel-heading"data-toggle="offcanvas">
               <div class="btn-group" id="buttonexport">
                  <span style="font-size: 15px;">
                     ...
                     <span>Recently Sale ItemWise List !</span>
                  </span>
               </div>
            </div>
            <div class="panel-body">
               <div class="btn-group">
                  ...
                  <a href="tejaserp-sale-billwise-list.php"><button class="btn btn-exp btn-sm dropdown-toggle ppbilllist" data-toggle=""style="background-color:#37475a; border-top-right-radius: 0px; border-bottom-right-radius: 0px; margin-top: -18px;"><i class="fa fa-bars"></i><span style="margin-left:3px;">Sale BillWise List !</span></button></a>
                  <div class="btn-group">
                  ...
                  <form name="latestsearchForm" id="latestsearchForm" method="post" class="search-form" action="" autocomplete="off">
                     ...
                     <div class="">
                        ...
                        <div class="col-sm-2">
                           ...
                           <p class="form-control bg-light t_qty"><?= countLatestRecords('tbl_bill', 'qty') ?></p>
                        </div>
                        <div class="col-sm-2">
                           <small>Total Rate</small>
                           <p class="form-control bg-light t_rate"><?= getTotalLatestValue('tbl_bill', 'rate') ?></p>
                        </div>
                        <div class="col-sm-2">
                           <small>Total GST</small>
                           <p class="form-control bg-light t_gst"><?= getTotalLatestValue('tbl_bill', 'gst_amount') ?></p>
                        </div>
                        <div class="col-sm-2">
                           <small>Total Amount</small>
                           <p class="form-control bg-light t_amt"><?= getTotalLatestValue('tbl_bill', 'amount') ?></p>
                        </div>
                        <div class="col-sm-4">
                           <small>Search</small>
                           <input type="text" class="form-control search-input" placeholder="Data Search" name="search">
                        </div>
                        <!--<div class="col-md-3">-->
         ...
         <div class="panel panel-bd lobidisable">
            ...
            <div class="panel-body">
               <div class="btn-group">
                  ...
                  <!--   }-->
                  <!--</style>-->
                  <a href="tejaserp-sale-billwise-list.php"><button class="btn btn-exp btn-sm dropdown-toggle ppbilllist" data-toggle=""style="background-color:#37475a; border-top-right-radius: 0px; border-bottom-right-radius: 0px; margin-top: -19px;"><i class="fa fa-bars"></i><span style="margin-left:3px;">Sale BillWise List !</span></button></a>
               ...
               <div class="row"style="background-color: #F5F5F5; margin-left:0px; margin-right:0px;">
                  <form name="searchForm" id="searchForm" method="post" class="search-form" action="" autocomplete="off">
                     ...
                     <div class="">
                        ...
                        <div class="col-sm-2">
                           <small>Sale Qty</small>
                           <p class="form-control bg-light t_qty"><?= countRecords('tbl_bill', 'qty') ?></p>
                        </div>
                        <div class="col-sm-2">
                           <small>Total Rate</small>
                           <p class="form-control bg-light t_rate"><?= getTotalValue('tbl_bill', 'rate') ?></p>
                        </div>
                        <div class="col-sm-2">
                           <small>Total GST</small>
                           <p class="form-control bg-light t_gst"><?= getTotalValue('tbl_bill', 'gst_amount') ?></p>
                        </div>
                        <div class="col-sm-2">
                           <small>Total Amount</small>
                           <p class="form-control bg-light t_amt"><?= getTotalValue('tbl_bill', 'amount') ?></p>
                        </div>
                        <div class="col-sm-2">
                           <small>From</small>
