...
<header class="main-header"style="height:50px;">
   <span class="btn-rounded"><i class="pe-7s fa-spin"></i></span>
   <a href="tejashotels-index.php" class="logo">
      <!-- Logo -->
   ...
   <nav class="navbar navbar-static-top">
      ...
      <span style="font-size: 20px; margin-left: 10px;"><a href="fh_dashboard.php"><span style="color:white;"></span></a></span>
      <div class="navbar-custom-menu ">
         <ul class="nav navbar-nav">
            <!-- Orders -->
            <li class="dropdown messages-menu">
               <a href="#" class="dropdown-toggle admin-notification" data-toggle="dropdown">
                  <i data-toggle="tooltip" data-placement="bottom" title="Confirm Normal Booking" class="pe-7s-bell"></i>
                  <!-- <p>hotel</p> -->
            ...
            <li class="dropdown notifications-menu">
               ...
               <i data-toggle="tooltip" data-placement="bottom" title="Confirm Advance Booking" class="pe-7s-bell"></i>
            ...
            <li class="dropdown notifications-menu">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown">
               <i data-toggle="tooltip" data-placement="bottom" title="Confirm GS Cancel Booking" class="pe-7s-bell"></i>
            ...
            <li class="dropdown notifications-menu">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown">
               <i data-toggle="tooltip" data-placement="bottom" title="Feedback" class="pe-7s-bell"></i>
               <span class="label label-success">7</span>
               </a>
               <ul class="dropdown-menu">
                  <li>
            ...
            <li class="dropdown notifications-menu">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown">
               <i data-toggle="tooltip" data-placement="bottom" title="Whatsapp" class="pe-7s-bell"></i>
            ...
            <li class="dropdown dropdown-user">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown">
               <img src="" class="img-circle" width="45" height="45" alt="user"></a>
               <ul class="dropdown-menu" >
                  <li>
                     <a href="profile.html">
