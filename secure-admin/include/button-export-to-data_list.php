...
<div class="btn-group">
   <button class="button-btn-btn btn-exp btn-sm dropdown-toggle" data-toggle="dropdown" style="background-color:#e8f1f3;"><i class="fa fa-bars"></i> Export Table Data</button>
