...
<section class="">
   <div class="row"style="margin-left:-29px; margin-right:-28px;">
      <div class="col-sm-12">
         <div class="panel panel-bd lobidisable" style="margin-right:5px;">
            <div class="panel-heading sidebar-toggle" data-toggle="offcanvas">
               <div class="btn-group" id="buttonexport">
                  <a href="#">
                     <h5><span style="margin-left:10px;color:#37475a;">Recently Purchase ItemWise List</span</h5>
                  </a>
               </div>
            </div>
            <div class="panel-body form-scroll">
                <div class="btn-group" style="margin-top:-15px;">
                  <style>
                   ...
                   <a href="purchase-master-billwise-list.php"><button class="btn btn-exp btn-sm dropdown-toggle ppbilllist" data-toggle=""style="background-color:#37475a; border-top-right-radius: 0px; border-bottom-right-radius: 0px;"><i class="fa fa-bars"></i><span style="margin-left:3px;">Purchase BillWise List !</span></button></a>
                  <div class="btn-group">
...
<section class="">
   <div class="row"style="margin-left:-29px; margin-right:-24px;">
      <div class="col-sm-12">
         <div class="panel panel-bd lobidisable">
            <div class="panel-heading sidebar-toggle" data-toggle="offcanvas">
               <div class="btn-group" id="buttonexport">
                  <a href="#">
                     <h5><span style="margin-left:10px; color:#37475a;">Purchase ItemWise List</span</h5>
                  </a>
               </div>
            </div>
            <div class="panel-body form-scroll">
