<?php include('top.php');
   ...
   {
     $id=$_GET['update_id'];
     $run=mysqli_query($conn,"select * from tbl_brand_master where id='$id'");
   ...
   if(isset($_POST['update']))
      {
       ...
       $query="UPDATE tbl_brand_master SET brand_code='$brand_code', brand_name='$brand_name',status='$status' WHERE id='$id'";
       if (mysqli_query($conn,$query)){
           $msg='<div class="alert alert-success alert-dismissible fade1 show">
                       <button type="button" class="close" data-dismiss="alert">&times;</button>
                       <strong>Group Name Update..!</strong>
                   </div>';
                   header('refresh:.5; url=fh_brandmastercreation_list.php');
       }
       else{
...
<html lang="en">
   ...
   <head>
      ...
      <title>Brand Master Update || TEJASERP</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Brand Master Edit !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_brandmastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>Add New Brand  Master Creation !</button></a>
                           </div>
                           <div class="btn-group">
                              <a href="fh_brandmastercreation_list.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-list-alt" style="margin-right: 5px;"></i>Brand  Master List !</button></a>
                           </div>
                           <form method="post">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       <label>Brand Code</label><label style="color:red;">*</label>
                                       <input type="password" name="brand_code" class="form-control" readonly value="<?php echo $user['brand_code'];?>" />
                                    </div>
                                 </div>
                                 <div class="col-sm-8">
                                    <div class="form-group">
                                       <label>Brand Name</label><label style="color:red;">*</label>
                                       <input type="text" class="form-control" name="brand_name" id="brand_name"  value="<?php echo $user['brand_name'];?>" placeholder="Enter Your brand Name" required>
                                    </div>
                                 </div>
                              </div>
                              <br>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                       ...
                                       <th data-toggle="offcanvas">Brand Code</th>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td class="button-btn-btn-btn2111">
                                          <a class=""onClick="return confirm('Are you sure you want to Update Brand Name?')" href="fh_brandmastercreation_update.php?update_id=<?php echo $user['id']; ?>">
                                          <span
                                             data-toggle="tooltip" title="Are you sure you want to Update Brand Name" type="button" class="" ><i style="color: white;" class="fa fa-pencil"></i><br>
                                          <span style="color: white;">EDIT</span>
                                          </span></a>
                                          <br><br>
                                          <a class="" onClick="return confirm('Are you sure you want to Delete Brand Name List ?')" href="fh_brandmastercreation_list.php?delete_id=<?php echo $user['id']; ?>">
                                          <span data-toggle="tooltip" title="Are you sure you want to Delete Brand Name List" type="button" class="" ><i style="color:white;" class="fa fa-trash-o"></i><span style="color:white;"class="">DELETE</span></span></a>
                                          <br><br>
                                          <label class="switch1">
                                          <input type="checkbox">
                                       ...
                                       <td data-toggle="offcanvas"><?php echo $user['brand_code']; ?>
                                       </td>
