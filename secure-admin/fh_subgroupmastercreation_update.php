<?php include('top.php');
   ...
   {
     $id=$_GET['update_id'];
     $run=mysqli_query($conn,"select * from tbl_subgroup_master where id='$id'");
   ...
   if(isset($_POST['update']))
      {
       ...
       $query="UPDATE tbl_subgroup_master SET subgroup_code='$subgroup_code',group_name='$group_name', subgroup_name='$subgroup_name',status='$status' WHERE id='$id'";
       if (mysqli_query($conn,$query)){
           $msg='<div class="alert alert-success alert-dismissible fade1 show">
                       <button type="button" class="close" data-dismiss="alert">&times;</button>
                       <strong>SubGroup Name Update..!</strong>
                   </div>';
                   header('refresh:.5; url=fh_subgroupmastercreation_list.php');
       }
       else{
...
<html lang="en">
   ...
   <head>
      ...
      <title>SubGroup Master Update || TEJASERP</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>SubGroup Master Edit !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_subgroupmastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>SubGroup  Master Creation !</button></a>
                           </div>
                           <div class="btn-group">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       ...
                                       <input type="password" name="subgroup_code" class="form-control" readonly value="<?php echo $user['subgroup_code'];?>" />
                                    </div>
                                 </div>
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       ...
                                       <select name="group_name" class="form-control" required>
                                          <option value="null">Select Group Name 
                                          </option>
                                          <?php
                                 ...
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="subgroup_name" id="subgroup_name"  value="<?php echo $user['subgroup_name'];?>" placeholder="Enter Your SubGroup Name" >
                                    </div>
                                 </div>
                              </div>
                              <br>
