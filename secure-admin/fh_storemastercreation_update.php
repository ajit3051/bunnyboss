...
{
  $id=$_GET['update_id'];
  $run=mysqli_query($conn,"select * from tbl_store_master where id='$id'");
...
if(isset($_POST['update']))
   {
    ...
    $query="UPDATE tbl_store_master SET store_code='$store_code', store_name='$store_name',location_name='$location_name',company_name='$company_name',status='$status' WHERE id='$id'";
    if (mysqli_query($conn,$query)){
        $msg='<div class="alert alert-success alert-dismissible fade1 show">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Store Name Update..!</strong>
                </div>';
                header('refresh:.5; url=fh_storemastercreation_list.php');
    }
    else{
...
<head>
      ...
      <title>Store Master Update || TEJASERP</title>
                              ...
                              <div class="row">
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                            ...
                                            <input type="password" name="store_code" class="form-control" readonly value="<?php echo $user['store_code'];?>" />
                                            </div>
                                         </div>
                                         <div class="col-sm-6">
                                          <div class="form-group">
                                 ...
                                 <div class="col-sm-6">
                                          <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="location_name" id="location_name"  value="<?php echo $user['location_name'];?>" placeholder="Enter Your Location Name" required>
                                            </div>
                                         </div>
                                         <div class="col-sm-6">
                                          <div class="form-group">
                                                <label>Company Name</label>
                                                <input type="text" class="form-control" name="company_name" id="company_name"  value="<?php echo $user['company_name'];?>" placeholder="Enter Your Company Name" required>
                                            </div>
                                         </div>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading" data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Store Master Edit List !</span>
                           </span>
                        </div>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td class="button-btn-btn-btn211">
                                          <a class=""onClick="return confirm('Are you sure you want to Update Store Name Master?')" href="fh_storemastercreation_update.php?update_id=<?php echo $user['id']; ?>"><i class="fa fa-pencil" style="color:white;"></i><br>
                                          <label style="color:white;"> EDIT</label>
                                          </a>
                                          <br><br>
                                          <a class=""onClick="return confirm('Are you sure you want to Update Store Name Master?')" href="fh_storemastercreation_update.php?update_id=<?php echo $user['id']; ?>"><i class="fa fa-list-alt" style="color:white;"></i>
