...
<?php
   $msg='';
    if(isset($_POST['submit']))
    {
     ...
     $status     = mysqli_real_escape_string($conn, $_POST['status']);
         ...
         $dup=mysqli_query($conn,"select * from tbl_color_master where color_name='$color_name'");
           if(mysqli_num_rows($dup)>0)
           {
               $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>Color Name Already exist!</strong>
                   </div>';
           }
           else{
               $query="Insert into tbl_color_master(color_code,color_name,status)values('$color_code','$color_name','$status')";
   ...
   ";
                   ...
                   $msg='<div class="alert alert-danger alert-dismissible fade1 show">
                   <button type="button" class="close" data-dismiss="alert">&times;</button>
                   <strong>Color Name Creations Failed!</strong>
                   </div>';
               }
           } 
       }
...
<html lang="en">
   ...
   <head>
      ...
      <title>Color Master Creation || TEJASERP</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Color Master Creations !</span>
                           </span>
                        </div>
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       ...
                                       <input type="password" name="color_code" class="form-control" id="color_code" readonly value="<?php @$no = mysqli_query($conn, "SELECT id FROM  tbl_color_master ORDER BY id DESC");
                                 ...
                                 <div class="col-sm-8">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="color_name" id="color_name" placeholder="Enter Your Color Name" required>
                                    </div>
                                 </div>
                              </div>
                              <br>
