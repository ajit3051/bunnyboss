...
{
  $id=$_GET['update_id'];
  $run=mysqli_query($conn,"select * from tbl_expenseshead_master where id='$id'");
...
if(isset($_POST['update']))
   {
    ...
    $exphead_name = str_replace("'", "\'", $exphead_name);
    $exphead_name = str_replace('"', '\"', $exphead_name);

        
    $query="UPDATE tbl_expenseshead_master SET exphead_code='$exphead_code', exphead_name='$exphead_name',status='$status' WHERE id='$id'";
...
<head>
      ...
      <title>Head Master Update || TEJASERP</title>
                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidisable">
                        ...
                        <div class="panel-body">
                            <div class="btn-group">
                              <a href="fh_expenses_headmastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-bars" style="margin-right: 5px;"></i>Expenses Head Master Creation</button></a>
                           </div>
                            <div class="btn-group">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                            ...
                                            <input type="password" name="exphead_code" class="form-control" readonly value="<?php echo $user['exphead_code'];?>" />
                                            </div>
                                         </div>
                                         <div class="col-sm-8">
                                          <div class="form-group">
                                                <label>ExpensesHead Name</label><label style="color:red;">*</label>
                                                <input type="text" class="form-control" name="exphead_name" id="exphead_name"  value="<?php echo $user['exphead_name'];?>" placeholder="Enter Your ExpensesHead Name" required>
                                            </div>
                                         </div>
