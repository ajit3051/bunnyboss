<?php include('top.php');
   ...
   {
     $id=$_GET['update_id'];
     $run=mysqli_query($conn,"select * from tbl_color_master where id='$id'");
   ...
   if(isset($_POST['update']))
      {
       ...
       $query="UPDATE tbl_color_master SET color_code='$color_code', color_name='$color_name',status='$status' WHERE id='$id'";
       if (mysqli_query($conn,$query)){
           $msg='<div class="alert alert-success alert-dismissible fade1 show">
                       <button type="button" class="close" data-dismiss="alert">&times;</button>
                       <strong>Color Name Update..!</strong>
                   </div>';
                   header('refresh:.5; url=fh_colormastercreation_list.php');
       }
       else{
...
<html lang="en">
   ...
   <head>
      ...
      <title>Color Master Update || TEJASERP</title>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Color Master Edit !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_colormastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>Color  Master Creation !</button></a>
                           </div>
                           <div class="btn-group">
                              <a href="fh_colormastercreation_list.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-list-alt" style="margin-right: 5px;"></i>Color  Master List !</button></a>
                           </div>
                           <form method="post">
                              ...
                              <div class="row">
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                       <label>Color Code</label><label style="color:red;">*</label>
                                       <input type="password" name="color_code" class="form-control" readonly value="<?php echo $user['color_code'];?>" />
                                    </div>
                                 </div>
                                 <div class="col-sm-8">
                                    <div class="form-group">
                                       <label>Color Name</label><label style="color:red;">*</label>
                                       <input type="text" class="form-control" name="color_name" id="color_name"  value="<?php echo $user['color_name'];?>" placeholder="Enter Your color Name" required>
                                    </div>
                                 </div>
                              </div>
                              <br>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading"data-toggle="offcanvas">
                           <span style="font-size: 15px;">
                              ...
                              <span>Color Master List !</span>
                           </span>
                        </div>
                        <div class="panel-body form-scroll">
                           <div class="btn-group">
                              <a href="fh_colormastercreation.php"> <button class="button-btn-btn btn-exp btn-sm"><i class="fa fa-plus" style="margin-right: 5px;"></i>Add New Color Master Creation !</button></a>
                           </div>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                       ...
                                       <th data-toggle="offcanvas">Color Code</th>
                                       <th data-toggle="offcanvas">Color Name</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    <?php
                                    ...
                                    <tr>
                                       ...
                                       <td class="button-btn-btn-btn2111">
                                          <a class=""onClick="return confirm('Are you sure you want to Update Color Name?')" href="fh_colormastercreation_update.php?update_id=<?php echo $user['id']; ?>">
                                          <span
                                             data-toggle="tooltip" title="Are you sure you want to Update Color Name" type="button" class="" ><i style="color: white;" class="fa fa-pencil"></i>
                                          <br>
                                          <span style="color: white;">EDIT</span>
                                          </span></a>
                                          <br><br>
                                          <a class="" onClick="return confirm('Are you sure you want to Delete Color Name List ?')" href="fh_colormastercreation_list.php?delete_id=<?php echo $user['id']; ?>">
                                          <span data-toggle="tooltip" title="Are you sure you want to Delete Color Name List" type="button" class="" ><i style="color:white;" class="fa fa-trash-o"></i><span style="color:white;"class="">DELETE</span></span></a>
                                          <br><br>
                                          <label class="switch1">
                                          <input type="checkbox">
                                       ...
                                       <td data-toggle="offcanvas"><?php echo $user['color_code']; ?>
                                       </td>
                                       <td data-toggle="offcanvas"><?php echo substr($user['color_name'],0,50); ?>
                                       </td>
                                    </tr>
                                    <?php } ?>
                                 </tbody>
