...
if ($exportType) {
   $columns = 'TB.purchage_date, TB.bill_number, TB.pay_mode, TB.account_name, TB.gst_type, SUM(TB.qty) as qty, SUM(CAST(TB.gst_amount AS DECIMAL(10,2))) as gst_amount, SUM(CAST(TB.amount AS DECIMAL(10,2))) as amount, TB.status, TPM.paymode_name';
} else {
   $columns = 'TB.id, TB.purchage_date, TB.bill_number, TB.pay_mode, TB.account_name, TB.gst_type, SUM(TB.qty) as qty, SUM(CAST(TB.gst_amount AS DECIMAL(10,2))) as gst_amount, SUM(CAST(TB.amount AS DECIMAL(10,2))) as amount, TB.status, TPM.paymode_name';
}
