...
{
   $id=$_GET['delete_id'];
   $sqld="DELETE FROM tbl_discount_master WHERE id='$id'";
   $res=mysqli_query($conn,$sqld);
   if($res)
   {
    header('refresh:.5; url=fh_discountmastercreation_list.php');
   }else{
    echo "<script>alert('Discount Master Record Failed');</script>";
   }
}
?>
...
<head>
      ...
      <title>Discount Master List || TEJASERP</title>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    <?php
                                          ...
                                          <a class=""onClick="return confirm('Are you sure you want to Update User Master Update?')" href="fh_discountmastercreation_update.php?update_id=<?php echo $user['id']; ?>">
                                          <span
                                             data-toggle="tooltip" title="Are you sure you want to Update User Master" type="button" class="" ><i style="color: white;" class="fa fa-pencil"></i><br><span style="margin-left:0px; color: white;">EDIT</span>
                                          </span></a><br><br>
                                          <a class="" onClick="return confirm('Are you sure you want to Delete User Master List ?')" href="fh_discountmastercreation_list.php?delete_id=<?php echo $user['id']; ?>">
                                          ...
                                          <span data-toggle="tooltip" title="Are you sure you want to Delete User Master List" type="button" class="" ><i style="margin-left: 0px; color:white;" class="fa fa fa-list-alt"></i><span style="margin-left:0px; color:white;">DETAILS</span></span></a>
                                          <br><br>
                                          <label class="switch1">
                                          <input type="checkbox">
