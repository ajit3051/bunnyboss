    ...
    $msg='';
     if(isset($_POST['submit']))
     {
      ...
      // $picture=implode(' ',$data);
          ...
          $dup=mysqli_query($conn,"select * from tbl_salesman_master where salesman_name='$salesman_name'");
            if(mysqli_num_rows($dup)>0)
            {
                ...
                $query="Insert into tbl_salesman_master(salesman_code,salesman_name,mobile_no,store_name,location_name,status)values('$salesman_code','$salesman_name','$mobile_no','$store_name','$location_name','$status')";
...
<head>
      ...
      <title>SalesMan Master Creation || Fashion Hub</title>
                              ...
                              <div class="row">
                                 <div class="col-sm-2">
                                    <div class="form-group">
                                                        ...
                                                        <input type="password" name="salesman_code" class="form-control" id="salesman_code" readonly value="<?php @$no = mysqli_query($conn, "SELECT id FROM  tbl_salesman_master ORDER BY id DESC");
                                             ...
                                             <div class="col-sm-5">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text" class="form-control" name="salesman_name" id="salesman_name" placeholder="Enter Your SalesMan Name" required>
                                                </div>
                                             </div>
                                             <div class="col-sm-5">
                                                <div class="form-group">
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-sm-5">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text" class="form-control" name="location_name" id="location_name" placeholder="Enter Your Location" required>
                                                </div>
                                             </div>
